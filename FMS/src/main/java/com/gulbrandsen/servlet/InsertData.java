...
public class InsertData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = (PreparedStatement) conn.prepareStatement("insert into test.product_master(product_group, product_abbr,product_name,status, cmp_id) VALUES (?,?,?,?,?)");
